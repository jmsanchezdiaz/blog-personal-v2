      ...
      <div className='flex gap-6'>
        ...
        <div className='space-y-2'>
          ...
          <div className='text-3xl flex gap-2'>
            <a href="https://github.com/jmsanchezdiaz" target='_blank' className="hover:text-gray-500">
              <FaGithub />
            </a>
            <a className="hover:text-gray-500" href="https://www.linkedin.com/in/juan-manuel-sanchez-diaz/" target='_blank'>
              <FaLinkedin />
            </a>
          </div>
        </div>
